    ...
    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>" method="post">
      <div class ="row register-form ">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="MrdNo" name="MrdNo" aria-describedby="MrdNo" placeholder="MrdNo" required > 
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="Name" class="form-control" id="Name" name="Name" aria-describedby="Name" placeholder="Name" required> 
        </div>
        <div class="form-group">
